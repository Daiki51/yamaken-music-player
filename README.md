...
> 本プロジェクトのスケッチを動作させるためには、[Arduino Client for MQTT (PubSubClient)](https://github.com/knolleary/pubsubclient)と[SerialCommand](https://github.com/kroimon/Arduino-SerialCommand)の変更が必要です。
